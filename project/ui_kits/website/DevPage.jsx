...
export function DevPage() {
  ...
  return (
    <div data-screen-label="developers page">
      <section style={{ borderTop: 0 }} data-num="01" data-screen-label="quick start">
      ...
      <section data-num="02" data-screen-label="developer advantages">
...
if (param) chart.loadState(JSON.parse(atob(param)));`}</CodeBlock>
      ...
      <section data-num="03" data-screen-label="architecture">
      ...
      <section data-num="04" data-screen-label="catalog">
      ...
      <section data-num="05" data-screen-label="keyboard">
      ...
      <section data-num="06" data-screen-label="theming">
