...
export function ProductPage({ onOpenDev }) {
  return (
    <div data-screen-label="product page">
      <header className="tl-hero" data-screen-label="hero">
        <div>
          ...
          <div className="cta">
            <Button variant="ember" size="lg">Open playground</Button>
      ...
      <div style={{ paddingBottom: 60 }} data-screen-label="proof strip">
      ...
      <section id="engine" data-num="01" data-screen-label="pillars">
      ...
      <section data-num="02" data-screen-label="for developers teaser">
...
chart.setData(candles);`}</CodeBlock>
  ...
  { type: 'rsi', period: 14 },
      ...
      <section id="compare" data-num="03" data-screen-label="compare">
