...
export function LandingCommunity() {
  return (
    <div data-screen-label="community">
      <section id="docs" data-num="docs" data-screen-label="documentation">
        ...
        <div className="tl-docs">
          {DOCS.map(([k, t, d, href]) => (
            <a className="tl-doc" key={t} href={href}>
      ...
      <section id="support" data-num="fund" data-screen-label="support">
        ...
        <div className="tl-support">
          <div className="tl-sup">
            ...
            <div className="act">
              <Button variant="ember">Sponsor on GitHub</Button>
            </div>
          </div>
          <div className="tl-sup">
          ...
          <div className="tl-sup">
            ...
            <div className="act">
              <Button onClick={() => { window.location.href = 'https://github.com/rekurt/ohlcv-front/issues'; }}>
                Open an issue ↗
              </Button>
            </div>
          </div>
      ...
      <section id="contacts" data-num="ping" data-screen-label="contacts">
        ...
        <div className="tl-contacts">
          ...
          <a className="tl-contact" href="https://github.com/rekurt">
          ...
          <a className="tl-contact" href="https://t.me/nikita_rwhe">
